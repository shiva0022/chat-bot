...
const Sidebar = () => {
  return (
    <div className="h-[calc(100vh-5rem)] w-[20vw] rounded-2xl bg-[#0a0a0a]/90 backdrop-blur-xl border border-[#a970ff]/10 shadow-2xl flex flex-col relative overflow-hidden">
